...
- `Lizenzfinder-App-V1_20_20260819-codex.html`
- `versions/aktuell/...`
...
Sie spiegeln den Stand der modularen V1.20-Fassung. Kleinere Textaenderungen koennen weiterhin im Chat beschrieben werden. Groessere Textaenderungen koennen direkt in den Markdown-Dateien vorbereitet werden.
