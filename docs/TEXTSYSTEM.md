...
- `Lizenzfinder-App-V1_19_20260819-codex.html`
- `versions/aktuell/...`
...
Sie spiegeln den Stand der modularen V1.19-Fassung. Kleinere Textaenderungen koennen weiterhin im Chat beschrieben werden. Groessere Textaenderungen koennen direkt in den Markdown-Dateien vorbereitet werden.
