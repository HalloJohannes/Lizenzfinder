const VERSION_METADATA = {
    ...
    const strings = {
      de: {
        ...
        sideHandle: "Über diese Anwendung", sideH: "Über diese Anwendung", aboutCreditA: "Der Lizenzfinder wurde entwickelt von", aboutCreditB: ", 2026.", aboutVersion: "Produktversion", aboutPurpose: "Wofür ist der Lizenzfinder da?", aboutPurposeP: "Der Lizenzfinder hilft dabei, für selbst erstellte Materialien eine passende Creative-Commons-Lizenz einzuordnen und anschließend einen Lizenzvermerk zu erstellen. Er bietet Orientierung; eine rechtliche Einzelfallprüfung ersetzt er nicht.", aboutNetworkStorage: "Netzwerk und Speicherung", aboutNetworkStorageP: "Die Anwendung läuft als einzelne HTML-Datei ohne externe Laufzeitressourcen. Eingaben bleiben nur im geöffneten Browserfenster; es werden keine Cookies gesetzt und keine Analyse- oder Tracking-Dienste eingebunden. Externe Links öffnen sich nur nach einem bewussten Klick.", aboutOrigin: "Entstehung", aboutOriginP: "Entstanden im Vibe-Coding: Die erste Fassung wurde mit Unterstützung von Claude geschrieben und anschließend mit Codex weiterentwickelt, strukturiert und getestet. Konzeption, Auswahl, Prüfung und Veröffentlichung verantwortet Johannes Koch.", aboutLicense: "Lizenz", aboutLicenseP: "Der Quellcode steht unter der <a href=\"https://opensource.org/license/mit\" target=\"_blank\" rel=\"noopener\">MIT-Lizenz</a>. Nutzung, Bearbeitung und Weitergabe sind erlaubt, solange Lizenzhinweis und Urheberangabe erhalten bleiben. Die redaktionellen Inhalte stehen unter CC0 1.0.", aboutDisclaimer: "Hinweis", aboutDisclaimerP: "Lizenzempfehlungen und generierte Vermerke können eine fachliche und rechtliche Prüfung nicht ersetzen. Ergebnisse sollten vor der Veröffentlichung geprüft werden.", aboutLicenseText: "Lizenztext anzeigen", contentLicenseNote: "Redaktionelle Inhalte:", contact: "Kontakt",
        footCreditA: "Diese Anwendung „Lizenzfinder“ wurde 2026 von", footCreditB: "mithilfe von KI (Claude/Anthropic, Codex/OpenAI) erstellt und darf gern geteilt und weitergegeben werden.", footCreditC: "Lizenz:", footContentLicense: "redaktionelle Inhalte:",
      ...
      en: {
        ...
        sideHandle: "About this app", sideH: "About this app", aboutCreditA: "The License Finder was developed by", aboutCreditB: ", 2026.", aboutVersion: "Product version", aboutPurpose: "What is the License Finder for?", aboutPurposeP: "The License Finder helps classify a suitable Creative Commons license for self-created materials and then create an attribution notice. It provides orientation; it does not replace legal review for individual cases.", aboutNetworkStorage: "Network and storage", aboutNetworkStorageP: "The application runs as a single HTML file without external runtime resources. Inputs remain only in the open browser window; no cookies are set and no analytics or tracking services are included. External links open only after a deliberate click.", aboutOrigin: "Origin", aboutOriginP: "Created through vibe coding: the first version was written with support from Claude and then further developed, structured, and tested with Codex. Concept, selection, review, and publication are the responsibility of Johannes Koch.", aboutLicense: "License", aboutLicenseP: "The source code is licensed under the <a href=\"https://opensource.org/license/mit\" target=\"_blank\" rel=\"noopener\">MIT License</a>. Use, modification, and distribution are permitted as long as the license notice and attribution are preserved. The editorial content is released under CC0 1.0.", aboutDisclaimer: "Notice", aboutDisclaimerP: "License recommendations and generated attribution notices cannot replace professional or legal review. Results should be checked before publication.", aboutLicenseText: "Show license text", contentLicenseNote: "Editorial content:", contact: "Contact",
        footCreditA: "This application “License Finder” was created in 2026 by", footCreditB: "with AI assistance (Claude/Anthropic, Codex/OpenAI) and may be shared and redistributed.", footCreditC: "License:", footContentLicense: "editorial content:",
        deed: "Deed", legal: "Legal code", badge: "Badge"
      }
    };
